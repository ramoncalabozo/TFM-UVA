...
def pintarPredicciones(prediccion, salidaTest):
...
def pintarResultadosModelo(history):
...
def pintarDiferencias(diferenciaAOD, diferenciaSSA, diferenciaG):
    # AOD
    ...
    plt.plot((entradaTest[:,5])*escala[5],diferenciaSSA,'.')
    plt.xlabel('RRI')
    plt.ylabel('$SSA{pred}$-$SSA{ref}$')
    plt.show()

    plt.plot((entradaTest[:,6])*escala[6],diferenciaSSA,'.')
    plt.xlabel('IMI')
    plt.ylabel('$SSA{pred}$-$SSA{ref}$')
    plt.show()
    ...
    plt.plot((entradaTest[:,5])*escala[5],diferenciaG,'.')
    plt.xlabel('RRI')
    plt.ylabel('$G{pred}$-$G{ref}$')
    plt.show()

    plt.plot((entradaTest[:,6])*escala[6],diferenciaG,'.')
    plt.xlabel('IMI')
    plt.ylabel('$G{pred}$-$G{ref}$')
    plt.show()

def pintarHistogramas(diferenciaAOD, diferenciaSSA, diferenciaG, Nbins):
# EL AOD    
...
# NORMALIZO LOS PESOS AL PRIMER VALOR
   ...
   #ESCRIBO EN UN FICHERO LOS LOGROS QUE VA HACIENDO EL MODELO
    ...
    pintarResultadosModelo(history)
    ...
    pintarPredicciones(prediccion, salidaTest)
...
# LAS DIFERNECIAS
    ...
    pintarDiferencias(diferenciaAOD, diferenciaSSA, diferenciaG)

    pintarHistogramas(diferenciaAOD, diferenciaSSA, diferenciaG, Nbins)
